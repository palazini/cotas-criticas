...
export default function ImagePinBoard({
  ...
  // wrapper -> caixa externa; stage -> área útil (sem borda/padding)
  ...
  return (
    <Box pos="relative" style={{ height: height ?? '100%', background: '#0b0f14', borderRadius: 12, overflow: 'hidden' }}>
      <div ref={stageRef} style={{ position: 'absolute', inset: 0 }} onClick={clickStage}>
        ...
        {pins.map((p) => {
            ...
            const size = 26; // ajuste fino aqui (24–28 fica ótimo)
            ...
            return (
                ...
                style={{
                    ...
                    // sem largura/altura aqui; quem define é o ThemeIcon
                    pointerEvents: 'auto',
                }}
                onClick={(e) => {
                    e.stopPropagation();
                ...
                <Tooltip label={labelFull || p.id} withArrow>
                    ...
                    radius="xl"
                    variant="gradient"
                    gradient={{ from: 'blue.4', to: 'blue.7', deg: 180 }}
                    style={{
                        // anel fininho e glow leve
                        boxShadow:
                        ...
                        lineHeight: 1,                   // sem interferência
                    }}
                    onMouseEnter={(e) => {
